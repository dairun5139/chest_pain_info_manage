          ...
          <div class="module basic-info">
            ...
            <div class="form-row">
              ...
              <div class="form-row-item">
                ...
                <select id="idType" :value="formData.idType">
              ...
              <div class="form-row-item">
                ...
                <input id="idNumber" v-model="formData.idNumber" type="text" placeholder="无证件号">
              </div>
          ...
          <div class="module">
            ...
            <div class="form-row">
              <div class="form-row-item">
                ...
                <input id="onsetTime" :value="emergencyData.onsetTime" type="text" :max="maxDateTime" @change="validateTime(emergencyData, 'onsetTime')">
              </div>
            ...
            <div v-if="chestPainData.ecg === 'True'">
              ...
              <div v-for="(ecg, index) in chestPainData.ecgs" :key="index" class="form-row">
                ...
                <div class="form-row-item">
                  ...
                  <input :id="'ecgFile' + index" type="file" @change="(event) => handleFileUpload(event, index)">
                </div>
                <div class="form-row-item">
