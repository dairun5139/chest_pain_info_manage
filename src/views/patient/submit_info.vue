        ...
        <div class="module">
          ...
          <div class="form-row">
            ...
            <div class="form-row-item">
              ...
              <select id="idType" v-model="formData.idType">
            ...
            <div class="form-row-item">
              ...
              <input id="idNumber" v-model="formData.idNumber" type="text" placeholder="请输入证件号">
            </div>
          </div>
...
_collectControls(container) {
  ...
  return ctrls.filter(el => !el.disabled && !el.readOnly && this.isElementVisible(el));
},
_isFilled(ctrls) {
...
validateRequiredByStars() {
  try {
    ...
    async patAdInfoAdd(){
      const patAdMeDTO = {
        ambulanceUnit:Array.isArray(this.emergencyData.ambulanceUnit)?this.emergencyData.ambulanceUnit.join(','):(this.emergencyData.ambulanceUnit || ''), // 转换救护车类型
    ...
    async patEcgInfoAdd(){
      const patEcgDTO = {
        ...
        transmissionMethod: parseInt(this.chestPainData.transmissionMethod),
      };
    ...
    async heartAdd(){
      ...
      switch (this.chestPainData.diagFalsesis) {
        ...
        case 'NSTEMI':
          const patNstemiDTO = {
            ...
            emergencyInterventionCathLabStartTimeNstemi:formatDateTime(this.chestPainData.cathLabStartTime), // 启动导管室时间
      ...
      if (this.chestPainData.reperfusionMethod === '直接PCI' || this.chestPainData.reperfusionMethod === '溶栓' || this.chestPainData.reperfusionMethod === '补救PCI'){
        const patCatheterDTO = {
          ...
          patientId: this.catheterData.patientId,
          directPciDoctor:this.chestPainData.decidingDoctor,//决定医生
          directPciTime:this.chestPainData.chestPainData.interventionDecisionTime,//决定介入手术时间
