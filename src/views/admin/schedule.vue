  ...
  <div>
    <div v-if="!showdetail" class="app-container" style="text-align:center">
      <div class="demo-input-suffix">
        科室选择:
        <el-select v-model="depart" placeholder="科室选择" clearable style="width: 130px" class="filter-item" filterable @change="getRuleList">
      ...
      <el-table v-loading="listLoading" :data="ruleList" style="width: 100%;margin-top:30px;" stripe @selection-change="changerule">
        <el-table-column type="selection" width="55" @selection-change="changerule" />
    ...
    <div v-if="showdetail" class="app-container" style="text-align:center">
      <div class="demo-input-suffix">
        <el-form :model="addRule" inline>
          <el-form-item label="科室选择:">
            <el-select v-model="addRule.deptId" placeholder="科室选择" clearable style="width: 130px" class="filter-item" filterable @change="getDepDoctor">
              <el-option v-for="item in alldepart" :key="item.id" :label="item.name" :value="item.id" />
            </el-select>
          </el-form-item>
          <el-form-item>
      ...
      <el-table v-loading="listLoading" :data="scheduleList" style="width: 100%;margin-top:10px;" border @selection-change="selectrule">
        <el-table-column type="selection" width="55" @selection-change="selectrule" />
      ...
      <div>
        <el-form :model="addRule" inline style="margin-top:20px">
          <el-form-item label="规则名称">
            <el-input v-model="addRule.ruleName" placeholder="规则名称" class="filter-item" @keyup.enter.native="handleFilter" />
          </el-form-item>
          <el-form-item label="规则描述">
            <el-input v-model="addRule.description" placeholder="规则描述" class="filter-item" @keyup.enter.native="handleFilter" />
          </el-form-item>
